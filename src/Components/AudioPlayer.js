...
const handleVolumeDown = () => {
  ...
  return (
    <div>
    <img src="https://images.genius.com/4154e76a8d2d2a8ece304bf401a86c03.320x320x1.jpg" alt="Обложка" style={{ width: '100%', maxWidth: '400px' }} />        
    <h2>Music Title: Extemporized ophthalmic - Melechesh</h2>
